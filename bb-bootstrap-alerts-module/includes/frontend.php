...
<div class="bb-bootstrap-alerts">
    ...
    <a href="<?php echo ($nav_link = $settings->bbn_navigation_link != '') ? $nav_link = $settings->bbn_navigation_link : '#'; ?>"
       target="<?php echo $nav_target = $settings->bbn_navigation_target; ?>">
        <?php endif; ?>
        <!-- Alert class -->
        <div class="alert <?php echo $settings->bbn_dropdown_field; ?> fade in">
            <!-- Close Button -->
            <?php if ($settings->bbn_closable == 'yes'): ?>
                <span class="close" data-dismiss="alert" aria-label="close"><i class="fa fa-times"
